...
import wedWebImg1 from "@/marketing/features/WeddingWebsite/assets/websiteSlide1.svg";
import wedWebImg2 from "@/marketing/features/WeddingWebsite/assets/websiteSlide2.svg";
import wedWebImg3 from "@/marketing/features/WeddingWebsite/assets/websiteSlide3.svg";
                    ...
                    <div className="relative w-full max-w-[1200px] h-[403px] mx-auto flex items-center justify-center overflow-hidden">
                        ...
                        >
                            ...
                            <div className="absolute bottom-4 left-0 right-0 text-center z-20 px-5">
                                ...
                                <p className="text-white text-sm mt-1">June 15, 2022</p>
                            </div>
                        </motion.div>
                        ...
                        <AnimatePresence initial={false}>
                            ...
                            >
                                ...
                                <div className="absolute bottom-6 left-0 right-0 text-center z-20 py-28">
                                    ...
                                    <p className="text-white text-sm mt-2">May 10, 2023</p>
                        ...
                        <AnimatePresence initial={false}>
                            ...
                            >
                                ...
                                <div className='absolute bottom-4 left-0 right-0 text-center z-20'>
                                    ...
                                    <p className='text-white text-sm mt-2'>August 20, 2024</p>
                                </div>
                            </motion.div>
                        </AnimatePresence>
