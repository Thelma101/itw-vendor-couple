...
export default function VendorMessages() {
  ...
  return (
    <Box sx={{ px: { xs: 0, md: 2 }, py: { xs: 0, md: 2 }, pb: { xs: 10, md: 2 }, minWidth: 0 }}>
      <Box sx={{ px: { xs: 2, md: 1 }, mb: 2 }}>
        ...
        <Typography sx={{ fontFamily: 'var(--font-ui)', fontSize: 14, color: '#666', mt: 0.5 }}>
          Chat with couples — same inbox pattern as the couple dashboard
        </Typography>
      </Box>
    <Box
      sx={{
    ...
    >
      ...
      <Card
        sx={{
          width: { xs: '100%', md: 340 },
          borderRadius: 0,
          borderRight: { md: '1px solid #CCFDF2' },
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, minWidth: 0 }}>
            <Button
              ...
              sx={{ display: { xs: 'inline-flex', md: 'none' }, textTransform: 'none', minWidth: 0, px: 1, color: '#00838F', fontWeight: 700 }}
            >
              ←
            </Button>
            <Badge
