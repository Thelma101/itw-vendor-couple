...
import PhotoCollage from '@/marketing/components/PhotoCollage';
...
import EnhancedCategoryDropdown from '@/couple/components/EnhancedCategoryDropdown';

// Lazy-loaded homepage sections for performance
const BrowseByCategory = lazy(() => import('@/couple/components/home/BrowseByCategory'));
const Testimonials = lazy(() => import('@/couple/components/home/Testimonials'));
const WhyChooseUs = lazy(() => import('@/couple/components/home/WhyChooseUs'));
const RecentlyViewed = lazy(() => import('@/couple/components/home/RecentlyViewed'));
const PopularInArea = lazy(() => import('@/couple/components/home/PopularInArea'));
...
export default function HomePage() {
  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', bgcolor: 'white' }}>
      ...
      {/* Vendor Preview Modal — HomePage uses a legacy prop shape; cast until modal APIs are unified */}
      <VendorPreviewModal
        {...({
          open: previewOpen,
